...
# This script uses data from the San Francisco office of the Assessor-
# Recorder to explore and visualize time-space trends in home sales within
# San Francisco from 2009-2015.

# GLOBAL OPTIONS/PACKAGES/WORKING DIRECTORY -------------------------------
# Set working directory
#   We will save plots directly to a working directory so insert the path 
#   to your desired working directory in the line below.
setwd("<insert path to directory here>")
